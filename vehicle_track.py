"""
Run Yolov8 model and Bytetrack tracker on a video to get vehicle detections, track them and visualize the results
"""
...
def predict():
    ...
    while cap.isOpened():
        ...
        if success:
            ...
            results = model.track(frame, persist=True, classes=[2,5,7], verbose=False, conf=0.35)
